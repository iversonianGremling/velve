...
5. 🟢 Z3 **Tier-2** + relational witnesses — later, opt-in, for the semantic residue.
   *(Tier 2 is now LIVE for two obligations (2026-06, three slices): the fact env
   ...
   counterexample-in-the-error contract. Still open: the semantic residue proper
   (`proof.sorted`) and the relational witness.)*
