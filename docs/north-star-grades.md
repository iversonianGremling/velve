...
callback to another row def without invoking it) stays an opaque pseudo-ctor. Next: S4c —
effect tails on builtin HOF signatures, where Fn-unify must learn tails at all.
