...
ADT that contributed it. Declaration order of sharing ADTs no longer matters. Remaining
S3: Var/Unknown contribution leniency, mixed-arity shared names, fix-its.
