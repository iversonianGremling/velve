...
- [x] 🟢 **Write the unified numeric/dimension design note — DONE 2026-06**
  ...
  - [x] 🟢 **B2(i)+B2(ii)+B3(i) SHIPPED 2026-06.** Units: `United` variant +
    ...
    so it's `U8`/gate `u8`. Still queued: B3(ii) — the `overflow` obligation; and
    the optional B2(iii) general unit constructor (after Phase C imports).
